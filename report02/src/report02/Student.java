...
public class Student implements Comparable<Student> {
   ...
   public static class WithName implements Comparator<Student>{ //이름 
   ...
   public static class WithDept implements Comparator<Student>{ //학과이름 
	   public int compare(Student s1,Student s2) {
   ...
   public static class WithGrade implements Comparator<Student>{ //학년 
	   public int compare(Student s1,Student s2) {
   ...
   public int compareTo(Student s1) {//학번 
